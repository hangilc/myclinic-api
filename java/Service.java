...
public class Service {
    public interface ServerAPI {
        ...
        @POST("update-hoken")
        CompletableFuture<Boolean> updateHoken(@Body UpdateHokenDTO hoken);

        @POST("update-hoken")
        Call<Boolean> updateHokenCall(@Body UpdateHokenDTO hoken);
...
//        Call<List<IyakuhinMasterDTO>> searchIyakuhinMasterCall(@Query("text") String text, @Query("at") String at);
        ...
        CompletableFuture<List<DrugFullDTO>> searchPrevDrug(@Query("text") @nullable String text, @Query("patient-id") int patientId);
        ...
        CompletableFuture<Integer> startVisit(@Query("patient-id") int patientId,
                                              @Query("at") @nullable String atDateTime);
...
//        CompletableFuture<List<VisitPatientDTO>> listRecentVisits();
        ...
        @GET("list-visit-with-patient")
        CompletableFuture<List<VisitPatientDTO>> listRecentVisits(@Query("page") @nullable int page,
                                                                  @Query("items-per-page") @nullable int itemsPerPage);
        ...
        CompletableFuture<List<PaymentVisitPatientDTO>> listPaymentByPatient(@Query("patient-id") int patientId,
                                                                             @Query("n") @nullable int n);

        @GET("list-recent-payment")
        CompletableFuture<List<PaymentVisitPatientDTO>> listRecentPayment(@Query("n") @nullable int n);
...
//        CompletableFuture<List<WqueueFullDTO>> listWqueue();
        ...
        CompletableFuture<List<PatientDTO>> listRecentlyRegisteredPatients(@Query("n") @nullable int n);
